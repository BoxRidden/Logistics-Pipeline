  ...
  create or replace view `logistics-500519`.`logistics_mart`.`stg_shipments`
  OPTIONS()
  as WITH raw_shipments AS (
    SELECT
        shipment_id,
        tracking_code,
        hub_id,
...
SELECT
    ...
    -- Currency explicit definitions (1 USD = ~26,200 VND, might need manual update depends on 
